...
export const Offer = () => {
  return (
    <div className='bg-gradient-to-b to-mercury-200 from-mercury-50 pb-14 rounded-b-3xl relative md:h-[1458px]'>
      <div className='relative mb-12'>
        <Plate className='text-tory-blue-950 md:hidden' />
        <PlateT className='text-tory-blue-950 hidden md:block' />
        <p
          className={
