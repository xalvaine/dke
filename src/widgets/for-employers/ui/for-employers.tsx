...
export const ForEmployers = () => {
  return (
    <div className='bg-tory-blue-950 pt-48 -mt-24 px-4 pb-10 md:px-5'>
      <div className='bg-gradient-to-b from-malachite-400 to-malachite-950 rounded-3xl py-12 px-7'>
