...
export const Tests = () => {
  return (
    <div className='bg-gradient-to-b from-mercury-200 to-mercury-50 px-4 pb-14 rounded-b-3xl relative'>
      <Plate2 className='absolute -bottom-9 h-9 text-mercury-50 right-14 md:w-[191px] md:h-auto md:-bottom-[56px]' />
      ...
      >
        ...
        <BluePlateT className='absolute right-0 inset-y-0 my-auto' />
      </p>
      <ul
        className={
